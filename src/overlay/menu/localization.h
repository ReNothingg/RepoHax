...
X(LocKey_EyeLasersDesc, L"As host, uses networked Photon Blasters visible to stock clients", L"У хоста видны обычным клиентам через сетевые Photon Blaster") \
